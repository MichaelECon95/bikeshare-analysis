...
def station_stats(df):
    ...
    print('\nThe most commonly used combo of start station and end station adventures is:', Start_Station, " & ", End_Station)
...
def show_raw_data(df):
    ...
    while True:
        if raw_data == 'y':
            print(df.iloc[i:i+5, :])
            i += 5
            raw_data = input('Would you like to see 5 more? Y or N:').lower()
        else:
            break
